...
-- Volcando datos para la tabla bd_files.sys_dependencia: 2 rows
...
-- Volcando datos para la tabla bd_files.sys_menu: ~10 rows (aproximadamente)
...
-- Volcando datos para la tabla bd_files.sys_roles_menu: ~16 rows (aproximadamente)
...
INSERT INTO `sys_users` (`id_users`, `name`, `cc`, `id_dependencia`, `user`, `password`, `rol`, `email`, `status`, `last_entry`, `last_date`, `avatar`) VALUES
	(1, 'ADMINISTRADOR', '1043003865', '1', 'admin', '70873e8580c9900986939611618d7b1e', 1, 'jose.narvaez@sonovista.co', 1, '2021-05-26 16:44:39', '2021-05-25', 'avatar.png'),
