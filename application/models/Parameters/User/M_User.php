...
class M_User extends VS_Model {
    ...
    function CreateUser() {
        $data = array("name" => $this->name,"id_dependencia"=> $this->id_dependencia,"cc"=>$this->cc, "user" => $this->user, "rol" => $this->rol, "password" => md5(md5($this->password)), "email" => $this->email, "status" => 1, "last_entry" => date("Y-m-d H:i:s"),"last_date"=>'2017-01-01', "avatar" => $this->avatar);
