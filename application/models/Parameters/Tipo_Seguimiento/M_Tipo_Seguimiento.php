...
class M_Tipo_Seguimiento extends VS_Model {
    ...
    public function UpdateTipo() {
        ...
        $result = $this->db->update("sys_tipo_seguimiento", $data);
    ...
    function CreateTipo() {
        $data = array("description" => strtoupper($this->descripcion), "status" => $this->status);
        $result = $this->db->insert("sys_tipo_seguimiento", $data);
    ...
    function DeleteTipo() {
        $this->db->where("id_tipo",$this->id_tipo);
        $res = $this->db->update("sys_tipo_seguimiento",array("status"=>3));
