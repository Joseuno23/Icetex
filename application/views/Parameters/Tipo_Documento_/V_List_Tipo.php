<div class="app-content toggle-content">
    <div class="side-app">
        ...
        <div class="page-header">
            <h1 class="page-title"><span class="subpage-title">Modulo</span> Tipo Documento</h1>
        </div>
        <!-- End page-header -->
    ...
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="example-Modal3">Datos Tipo Documento</h5>
...
<script>
    ...
    function UpdateData(id_tipo) {
        ...
        $.ajax({
            url: "<?= base_url() ?>Parameters/Tipo_Documento/C_Tipo_Documento/UpdateTipo",
            type: 'POST',
            data: formData,
            async: false,
    ...
    function CreateData() {
        ...
        if (!error) {
            ...
            $.ajax({
                url: "<?= base_url() ?>Parameters/Tipo_Documento/C_Tipo_Documento/CreateTipo",
                type: 'POST',
                data: formData,
                async: false,
                success: function (data) {
    ...
    function Delete(id_tipo, titulo) {
        swal({
            ...
            if (result) {
                $.post("<?= base_url() ?>Parameters/Tipo_Documento/C_Tipo_Documento/DeleteTipo", {id_tipo: id_tipo}, function (data) {
                    if (data.res == "OK") {
