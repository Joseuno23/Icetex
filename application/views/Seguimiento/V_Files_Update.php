            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input readonly type="text" class="form-control req-upload" name="id_radicado" id="id_radicado" placeholder="Ejemplo: 10.02.05.1" value="<?=$info->codigo.'.'.$info->id_radicado?>">
                        <input type="hidden" class="form-control" name="id_seguimiento" id="id_seguimiento"  value="<?=$info->id_seguimiento?>">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label class="form-label">Tipo Seguimiento</label>
                        <input readonly type="text" class="form-control req-upload" name="id_tipo_seguimiento" id="id_tipo_seguimiento" value="<?=$info->tipo_seguimiento?>">
                    </div>
                </div>
                <div class="col-md-12">
                    <div class="form-group">
                        <label class="form-label">Titulo</label>
                        <input readonly type="text" class="form-control req-upload" name="titulo" id="titulo" placeholder="Titulo.." value="<?=$info->titulo?>">
                    </div>
                </div>
                <div class="col-md-12">
                    <div class="form-group">
                        <label class="form-label">Descripción</label>
                        <textarea readonly class="form-control req-upload" name="descripcion" id="descripcion" ><?=$info->descripcion?></textarea>
                    </div>
                </div>
                <div class="col-md-12">
